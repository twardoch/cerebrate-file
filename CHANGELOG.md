...
### Changed
- Improved loading performance for the dashboard.
- Updated dependencies.

### Fixed
- Login button on mobile devices.
- Bug causing data export to fail for large datasets.
...
### Fixed
- Corrected text overflow in the settings panel.

## [1.1.0] - 2023-07-20

### Added
- Search functionality for the main list.
